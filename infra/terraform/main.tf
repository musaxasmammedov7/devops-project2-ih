...
module "app_gateway" {
  ...
  fe_app_fqdn         = module.app_service.fe_app_default_hostname
  be_app_fqdn         = module.app_service.be_app_default_hostname
...
module "monitoring" {
  ...
  app_service_plan_id = module.app_service.fe_app_name # Or ASP ID if passed
